...
from syz_sage.cli.display import human_filter, human_filter_values
...
class FilterCliTests(unittest.TestCase):
    ...
    def test_filter_uses_read_only_database_without_network_or_data_changes(self) -> None:
        ...
        with (
            mock.patch(
                "syz_sage.cli.commands.Updater", side_effect=AssertionError("unexpected retrieval")
            ),
            mock.patch("syz_sage.cli.commands.Database", wraps=Database) as opened,
        ):
    ...
    def test_invalid_criteria_and_contradictory_flags_fail_before_paths_or_database(self) -> None:
        ...
        for arguments in invalid:
            with (
                ...
                mock.patch("syz_sage.cli.commands._paths") as paths,
            ):
