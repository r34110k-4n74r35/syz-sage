...
from syz_sage.client import FetchError, SyzbotClient
...
FIXTURES = ROOT / "tests/fixtures/legacy_data"
ALPHA_HASH = "a" * 40
...
class ScriptCommandTests(unittest.TestCase):
    ...
    def test_workbook_launcher_preserves_environment_and_explicit_destinations(self) -> None:
        with temporary_directory() as directory:
            ...
            with (
                mock.patch("syz_sage.storage.project_root", return_value=root / "checkout"),
                mock.patch.object(
    ...
    def test_common_writer_accepts_explicit_destination_outside_checkout(self) -> None:
        with temporary_directory() as directory:
            ...
            with mock.patch("syz_sage.storage.project_root", return_value=root / "checkout"):
