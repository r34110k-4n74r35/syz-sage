...
from syz_sage import display
from syz_sage.help import HelpParser
from syz_sage.sync import UpdateSummary
from syz_sage.terminal import terminal_width
...
class HumanDisplayTests(unittest.TestCase):
    def test_width_uses_the_output_stream_when_stdout_is_redirected(self):
        ...
        with (
            ...
            mock.patch(
                "syz_sage.terminal.os.get_terminal_size",
